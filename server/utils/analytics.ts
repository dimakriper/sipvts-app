...
export function generateMockRepo(owner: string, name: string): Repository {
  ...
  return {
    ...
    language: (['TypeScript', 'JavaScript', 'Python', 'Go', 'Rust', 'Vue', 'Java'] as string[])[
...
export const seedData: Repository[] = [
  {
    ...
    starsHistory: [42000, 42500, 43000, 43800, 44100, 44500, 44800, 45000, 45100, 45150, 45180, 45200],
  ...
  },
  {
    ...
    starsHistory: [158000, 159000, 160000, 160500, 160800, 161200, 161500, 161700, 161800, 161900, 161950, 162000],
    commitsHistory: [2500, 2600, 2700, 2650, 2750, 2800, 2850, 2900, 2950, 3000, 3050, 3100],
    issuesHistory: [8500, 8600, 8700, 8800, 8850, 8900, 8920, 8940, 8960, 8950, 8945, 8950],
